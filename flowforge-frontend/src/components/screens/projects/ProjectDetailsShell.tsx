          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button
                ...
                disabled={busy}
                className="rounded-full border border-[#dbe4f0] px-4 py-2.5 text-[13px] font-extrabold text-[#334155] disabled:opacity-60"
              >
                Back
              </button>
              ...
              <button
                ...
                onClick={onDelete}
                disabled={busy}
                className="rounded-full border border-rose-200 px-4 py-2.5 text-[13px] font-extrabold text-rose-600 disabled:opacity-60"
              >
                Delete
              </button>
            </div>
